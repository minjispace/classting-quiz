  ...
  return (
    <div className="p-4 flex justify-between items-center bg-green">
      <Link className="flex items-center" to="/">
        ...
        <div className="ml-2 font-extrabold text-2xl text-white tracking-wider">
          Classming
        </div>
      </Link>
      <div className="hidden md:block">
        ...
        <Link to="/feed-back">
          <button className="text-white bg-black hover:opacity-80 transition-all font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2">
            모든 오답 노트 보기
          </button>
        </Link>
      </div>
